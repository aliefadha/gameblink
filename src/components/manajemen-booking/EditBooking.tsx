...
export function EditBooking({ row }: EditBookingProps) {
                ...
                <DialogHeader className="flex flex-row items-center ">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                        <Select value={statusBooking} onValueChange={handleStatusChange} disabled={loading}>
                            <SelectTrigger
                                className={`rounded-full px-4 py-1 text-sm font-semibold flex items-center gap-2 w-auto text-white
                                    ${statusBooking === 'Aktif' ? 'bg-[#009B4F]' : statusBooking === 'Dibatalkan' ? 'bg-[#D31A1D]' : statusBooking === 'Selesai' ? 'bg-[#E9B03C]' : 'bg-gray-300'}`}
                            >
                                <SelectValue />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <div className="bg-[#FAF8F7] rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base">{row.original.metode_pembayaran || '-'}</div>
                            </div>
                            <div>
