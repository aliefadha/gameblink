...
export const editKetersediaanFormSchema = z.object({
    ...
    // If tanggal_selesai_blokir is provided, validate it's not less than tanggal_mulai_blokir
    ...
    // If both dates are the same and both times are provided, validate jam_selesai_blokir is not less than jam_mulai_blokir
